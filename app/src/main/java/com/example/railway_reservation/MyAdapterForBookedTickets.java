...
public class MyAdapterForBookedTickets extends RecyclerView.Adapter<MyAdapterForBookedTickets.MyViewHolder> {
    private Context context;
    private ArrayList tr_no,date,pnr;

    public MyAdapterForBookedTickets(Context context, ArrayList pnr, ArrayList tr_no, ArrayList date) {
    ...
    @Override
    public void onBindViewHolder(@NonNull MyAdapterForBookedTickets.MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context,updatebookingdate_screen.class);
